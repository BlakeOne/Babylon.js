...
export class NodeMaterial extends PushMaterial {
     ...
     * @returns a promise that will resolve to the new node material
     */
    public static ParseFromSnippetAsync(snippetId: string, scene: Scene = EngineStore.LastCreatedScene!, rootUrl: string = "", nodeMaterial?: NodeMaterial, skipBuild: boolean = false): Promise<NodeMaterial> {
        if (snippetId === "_BLANK") {
